...
import { SiGooglechrome, SiFirefoxbrowser,  SiOpera } from "react-icons/si";
...
<div className="flex flex-col items-center space-y-6">
  <a
    ...
    className="flex items-center justify-center bg-yellow-500 hover:bg-yellow-600 text-black font-semibold py-3 px-8 rounded-full transition shadow-md hover:shadow-yellow-500/30"
  >
  ...
  <div className="flex flex-wrap justify-center gap-3 text-sm text-gray-400">
    <span className="flex items-center gap-2 px-4 py-1.5 rounded-full border border-gray-700 bg-zinc-900/60">
      <SiFirefoxbrowser className="w-4 h-4 text-orange-400" />
      Firefox – Coming Soon
    </span>
    <span className="flex items-center gap-2 px-4 py-1.5 rounded-full border border-gray-700 bg-zinc-900/60">
  <Icon path={mdiMicrosoftEdge} size={0.75} className="text-blue-400" />
  Edge – Coming Soon
</span>
    <span className="flex items-center gap-2 px-4 py-1.5 rounded-full border border-gray-700 bg-zinc-900/60">
      <SiOpera className="w-4 h-4 text-red-400" />
      Opera – Coming Soon
    </span>
  </div>
</div>
